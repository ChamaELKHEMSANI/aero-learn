class QueryModal {
    ...
    updateFormLabels() {
        ...
        const checkboxLabel = document.querySelector('label[for="search-with-documents"]');
        if (checkboxLabel) {
            checkboxLabel.innerHTML = `<input type="checkbox" id="search-with-documents"> ${this.translate('withDocuments')}`;
        }
    }
    updateResultsText() {
    ...
    init() {
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button id="close-search-modal" class="close-modal">&times;</button>
            </div>
                ...
                <div class="search-filters">
                    ...
                    <div class="filter-group">
                        ...
                        <select id="search-key-attribute">
                            ...
                            <!-- Les options d'attributs key* seront générées dynamiquement -->
                        </select>
                    </div>
                    <div class="filter-group">
